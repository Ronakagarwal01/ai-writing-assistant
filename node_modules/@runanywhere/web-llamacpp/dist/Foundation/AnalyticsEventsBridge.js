...
// ---------------------------------------------------------------------------
var RACEventType;
(function (RACEventType) {
    // LLM (100-199)
    RACEventType[RACEventType["LLM_MODEL_LOAD_STARTED"] = 100] = "LLM_MODEL_LOAD_STARTED";
    RACEventType[RACEventType["LLM_MODEL_LOAD_COMPLETED"] = 101] = "LLM_MODEL_LOAD_COMPLETED";
    RACEventType[RACEventType["LLM_MODEL_LOAD_FAILED"] = 102] = "LLM_MODEL_LOAD_FAILED";
    RACEventType[RACEventType["LLM_MODEL_UNLOADED"] = 103] = "LLM_MODEL_UNLOADED";
    RACEventType[RACEventType["LLM_GENERATION_STARTED"] = 110] = "LLM_GENERATION_STARTED";
    RACEventType[RACEventType["LLM_GENERATION_COMPLETED"] = 111] = "LLM_GENERATION_COMPLETED";
    RACEventType[RACEventType["LLM_GENERATION_FAILED"] = 112] = "LLM_GENERATION_FAILED";
    RACEventType[RACEventType["LLM_FIRST_TOKEN"] = 113] = "LLM_FIRST_TOKEN";
    RACEventType[RACEventType["LLM_STREAMING_UPDATE"] = 114] = "LLM_STREAMING_UPDATE";
    // STT (200-299)
    RACEventType[RACEventType["STT_MODEL_LOAD_STARTED"] = 200] = "STT_MODEL_LOAD_STARTED";
    RACEventType[RACEventType["STT_MODEL_LOAD_COMPLETED"] = 201] = "STT_MODEL_LOAD_COMPLETED";
    RACEventType[RACEventType["STT_MODEL_LOAD_FAILED"] = 202] = "STT_MODEL_LOAD_FAILED";
    RACEventType[RACEventType["STT_MODEL_UNLOADED"] = 203] = "STT_MODEL_UNLOADED";
    RACEventType[RACEventType["STT_TRANSCRIPTION_STARTED"] = 210] = "STT_TRANSCRIPTION_STARTED";
    RACEventType[RACEventType["STT_TRANSCRIPTION_COMPLETED"] = 211] = "STT_TRANSCRIPTION_COMPLETED";
    RACEventType[RACEventType["STT_TRANSCRIPTION_FAILED"] = 212] = "STT_TRANSCRIPTION_FAILED";
    RACEventType[RACEventType["STT_PARTIAL_TRANSCRIPT"] = 213] = "STT_PARTIAL_TRANSCRIPT";
    // TTS (300-399)
    RACEventType[RACEventType["TTS_VOICE_LOAD_STARTED"] = 300] = "TTS_VOICE_LOAD_STARTED";
    RACEventType[RACEventType["TTS_VOICE_LOAD_COMPLETED"] = 301] = "TTS_VOICE_LOAD_COMPLETED";
    RACEventType[RACEventType["TTS_VOICE_LOAD_FAILED"] = 302] = "TTS_VOICE_LOAD_FAILED";
    RACEventType[RACEventType["TTS_VOICE_UNLOADED"] = 303] = "TTS_VOICE_UNLOADED";
    RACEventType[RACEventType["TTS_SYNTHESIS_STARTED"] = 310] = "TTS_SYNTHESIS_STARTED";
    RACEventType[RACEventType["TTS_SYNTHESIS_COMPLETED"] = 311] = "TTS_SYNTHESIS_COMPLETED";
    RACEventType[RACEventType["TTS_SYNTHESIS_FAILED"] = 312] = "TTS_SYNTHESIS_FAILED";
    RACEventType[RACEventType["TTS_SYNTHESIS_CHUNK"] = 313] = "TTS_SYNTHESIS_CHUNK";
    // VAD (400-499)
    RACEventType[RACEventType["VAD_STARTED"] = 400] = "VAD_STARTED";
    RACEventType[RACEventType["VAD_STOPPED"] = 401] = "VAD_STOPPED";
    RACEventType[RACEventType["VAD_SPEECH_STARTED"] = 402] = "VAD_SPEECH_STARTED";
    RACEventType[RACEventType["VAD_SPEECH_ENDED"] = 403] = "VAD_SPEECH_ENDED";
    RACEventType[RACEventType["VAD_PAUSED"] = 404] = "VAD_PAUSED";
    RACEventType[RACEventType["VAD_RESUMED"] = 405] = "VAD_RESUMED";
    // Voice Agent (500-599)
    RACEventType[RACEventType["VOICE_AGENT_TURN_STARTED"] = 500] = "VOICE_AGENT_TURN_STARTED";
    RACEventType[RACEventType["VOICE_AGENT_TURN_COMPLETED"] = 501] = "VOICE_AGENT_TURN_COMPLETED";
    RACEventType[RACEventType["VOICE_AGENT_TURN_FAILED"] = 502] = "VOICE_AGENT_TURN_FAILED";
    RACEventType[RACEventType["VOICE_AGENT_STT_STATE_CHANGED"] = 510] = "VOICE_AGENT_STT_STATE_CHANGED";
    RACEventType[RACEventType["VOICE_AGENT_LLM_STATE_CHANGED"] = 511] = "VOICE_AGENT_LLM_STATE_CHANGED";
    RACEventType[RACEventType["VOICE_AGENT_TTS_STATE_CHANGED"] = 512] = "VOICE_AGENT_TTS_STATE_CHANGED";
    RACEventType[RACEventType["VOICE_AGENT_ALL_READY"] = 513] = "VOICE_AGENT_ALL_READY";
    // SDK Lifecycle (600-699)
    RACEventType[RACEventType["SDK_INIT_STARTED"] = 600] = "SDK_INIT_STARTED";
    RACEventType[RACEventType["SDK_INIT_COMPLETED"] = 601] = "SDK_INIT_COMPLETED";
    RACEventType[RACEventType["SDK_INIT_FAILED"] = 602] = "SDK_INIT_FAILED";
    RACEventType[RACEventType["SDK_MODELS_LOADED"] = 603] = "SDK_MODELS_LOADED";
    // Model Download (700-719)
    RACEventType[RACEventType["MODEL_DOWNLOAD_STARTED"] = 700] = "MODEL_DOWNLOAD_STARTED";
    RACEventType[RACEventType["MODEL_DOWNLOAD_PROGRESS"] = 701] = "MODEL_DOWNLOAD_PROGRESS";
    RACEventType[RACEventType["MODEL_DOWNLOAD_COMPLETED"] = 702] = "MODEL_DOWNLOAD_COMPLETED";
    RACEventType[RACEventType["MODEL_DOWNLOAD_FAILED"] = 703] = "MODEL_DOWNLOAD_FAILED";
    RACEventType[RACEventType["MODEL_DOWNLOAD_CANCELLED"] = 704] = "MODEL_DOWNLOAD_CANCELLED";
    // Model Extraction (710-719)
    RACEventType[RACEventType["MODEL_EXTRACTION_STARTED"] = 710] = "MODEL_EXTRACTION_STARTED";
    RACEventType[RACEventType["MODEL_EXTRACTION_PROGRESS"] = 711] = "MODEL_EXTRACTION_PROGRESS";
    RACEventType[RACEventType["MODEL_EXTRACTION_COMPLETED"] = 712] = "MODEL_EXTRACTION_COMPLETED";
    RACEventType[RACEventType["MODEL_EXTRACTION_FAILED"] = 713] = "MODEL_EXTRACTION_FAILED";
    // Model Deletion (720-729)
    RACEventType[RACEventType["MODEL_DELETED"] = 720] = "MODEL_DELETED";
    // Storage (800-899)
    RACEventType[RACEventType["STORAGE_CACHE_CLEARED"] = 800] = "STORAGE_CACHE_CLEARED";
    RACEventType[RACEventType["STORAGE_CACHE_CLEAR_FAILED"] = 801] = "STORAGE_CACHE_CLEAR_FAILED";
    RACEventType[RACEventType["STORAGE_TEMP_CLEANED"] = 802] = "STORAGE_TEMP_CLEANED";
    // Device (900-999)
    RACEventType[RACEventType["DEVICE_REGISTERED"] = 900] = "DEVICE_REGISTERED";
    RACEventType[RACEventType["DEVICE_REGISTRATION_FAILED"] = 901] = "DEVICE_REGISTRATION_FAILED";
    // Network (1000-1099)
    RACEventType[RACEventType["NETWORK_CONNECTIVITY_CHANGED"] = 1000] = "NETWORK_CONNECTIVITY_CHANGED";
    // Error (1100-1199)
    RACEventType[RACEventType["SDK_ERROR"] = 1100] = "SDK_ERROR";
    // Framework (1200-1299)
    RACEventType[RACEventType["FRAMEWORK_MODELS_REQUESTED"] = 1200] = "FRAMEWORK_MODELS_REQUESTED";
    RACEventType[RACEventType["FRAMEWORK_MODELS_RETRIEVED"] = 1201] = "FRAMEWORK_MODELS_RETRIEVED";
})(RACEventType || (RACEventType = {}));
// ---------------------------------------------------------------------------
...
export class AnalyticsEventsBridge {
     ...
     */
    register(module, telemetryCallback) {
        ...
        this._callbackPtr = module.addFunction((eventType, dataPtr, _userData) => {
     ...
     */
    cleanup() {
        if (!this._module || this._callbackPtr === 0)
            return;
    ...
    emitToEventBus(eventType, dataPtr) {
        ...
        switch (eventType) {
            ...
            case RACEventType.MODEL_DOWNLOAD_PROGRESS: {
                ...
                const bytesDownloaded = m.getValue(base + 16, 'i64');
                const totalBytes = m.getValue(base + 24, 'i64');
            ...
            case RACEventType.MODEL_DOWNLOAD_COMPLETED: {
                const base = dataPtr + DATA_OFFSET;
                const modelId = this.readStringAt(m, base);
                const sizeBytes = m.getValue(base + 40, 'i64'); // size_bytes field
...
//# sourceMappingURL=AnalyticsEventsBridge.js.map